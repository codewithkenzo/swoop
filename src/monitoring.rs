...
impl MonitoringSystem {
    /// Initialize the monitoring system with Prometheus metrics
    pub fn new() -> Result<Self> {
        // Set up Prometheus metrics layer
        let (_prometheus_layer, metrics_handle) = PrometheusMetricLayer::pair();
        ...
        Ok(Self {
            metrics_handle: axum_prometheus::Handle(metrics_handle),
            stats,
            health_checker,
